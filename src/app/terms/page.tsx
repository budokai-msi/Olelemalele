  ...
  return (
    <main className="min-h-screen bg-surface text-on-surface pt-32 pb-24 px-4 md:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <div className="space-y-12 text-on-muted">
            <section>
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">2. Products and Services</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">3. Orders and Payment</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">4. Shipping and Delivery</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">5. Returns and Refunds</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">7. User Accounts</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-on-surface mb-4">11. Contact</h2>
              <p className="leading-relaxed">
                For questions about these Terms of Service, contact us at:
              </p>
              <div className="mt-4 p-6 rounded-xl bg-accent/[0.02] border border-[rgb(var(--border))]">
        ...
        >
          <Link href="/privacy" className="text-on-muted hover:text-accent transition-colors">
            Privacy Policy
          </Link>
