                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                      ...
                      <a href="/privacy" className="text-indigo-400 hover:text-indigo-300 ml-1 underline underline-offset-2">
                        Learn more
                      </a>
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    ...
                    <motion.button
                      ...
                      className="px-6 py-3 rounded-full bg-white text-black text-sm font-bold uppercase tracking-wider hover:bg-indigo-500 hover:text-white transition-all"
                    >
                      Accept All
                    </motion.button>
                  </div>
